...
<div class="card">
    <div class="p-6">
        ...
        <div class="justify-between items-center mb-4">
            <h3 class="card-title mb-4">Table pengajuan surat oleh warga dengan status <strong class="text-danger uppercase">Ditolak</strong></h3>
        </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="px-4 py-4 text-center text-sm text-gray-500 dark:text-gray-300">
                                        Tidak ada surat status ditolak.
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
        ...
        <p class="mt-4 text-sm text-gray-600 dark:text-gray-300">
            Menampilkan total <span class="font-semibold">{{ $pengajuans->count() }}</span> surat status ditolak.
        </p>
