...
<head>
    @include('admin.layouts.shared/title-meta', ['title' => 'Error 404'])
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="px-6 py-10">
                        <div class="text-center">
                            <h1 class="text-primary text-7xl drop-shadow-xl">4<i class="ri-emotion-sad-line"></i>4</h1>
                            ...
                            <a href="{{ route('admin.dashboard') }}" class="btn bg-info text-white mt-10"><i class="ri-home-4-line me-2"></i> Back to Home</a>
                        </div>
                    </div>
                </div> <!-- end card -->
