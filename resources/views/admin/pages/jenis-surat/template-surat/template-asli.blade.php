...
<body>
    ...
    <table>
        ...
        <div class="content">
            <p>Bersama ini kami hadapkan seorang warga yang tersebut dibawag ini :</p>
            
            <table>
                <tr>
                    <td width="150">Nama</td>
                    <td>: <input type="text" style="width:350px" name="nama"></td>
                </tr>
                <tr>
                    <td>Jenis Kelamin</td>
                ...
                <tr>
                    ...
                    <td>: <input type="text" style="width:350px" name="ttl"></td>
                </tr>
                <tr>
                    <td>Status Perkawinan</td>
                    <td>: Kawin / Belum kawin / Cerai Hidup/ Cerai Mati</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Pekerjaan</td>
                    <td>: <input type="text" style="width:350px" name="pekerjaan"></td>
                </tr>
                <tr>
                    <td>Agama</td>
                    <td>: Islam / Kristen / Katholik / Budha / Hindu</td>
                </tr>
                <tr>
                    <td valign="top">Alamat</td>
                    <td>: Jl. <input type="text" style="width:250px" name="jalan"> No. <input type="text" style="width:30px" name="nomor"> RT. 036<br>
                    Kelurahan Gunung Samarinda Kecamatan Balikpapan Utara</td>
                </tr>
            </table>
