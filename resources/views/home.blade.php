        ...
        <div class="flex justify-center">
            <div class="max-w-md px-4 mx-auto">
                <div class="card overflow-hidden">
                    ...
                    <!-- Logo -->
                    <div class="p-6 bg-info">
                    </div>

                    <div class="px-6 py-10">
                        <div class="text-center">
                            <h4 class="text-danger text-lg uppercase my-7">Selamat Datang</h4>
                            <p>Halaman ini merupakan halaman sementara karena dalam tahap pengembangan.</p>
                            <a href="{{ route('login') }}" class="btn bg-info text-white mt-10">Tekan untuk Login</a>
                        </div>
                    </div>
                </div> <!-- end card -->
