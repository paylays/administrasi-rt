...
var dataColors = document.querySelector("#simple-candlestick").dataset.colors;
if (dataColors) {
...
//
var colors = ["#47ad77", "#fa5c7c"];
var dataColors = document.querySelector("#combo-candlestick").dataset.colors;
if (dataColors) {
    colors = dataColors.split(",");
}
...
var colors = ["#3e60d5", "#ffbc00"];
var dataColors = document.querySelector("#combo-bar-candlestick").dataset.colors;
if (dataColors) {
    colors = dataColors.split(",");
}
var options = {
...
var colors = ["#3e60d5", "#ffbc00"];
var dataColors = document.querySelector("#x-axis-candlestick").dataset.colors;
if (dataColors) {
    colors = dataColors.split(",");
}
...
var colors = ["#3e60d5", "#ffbc00"];
var dataColors = document.querySelector("#candlestick-with-line").dataset.colors;
if (dataColors) {
    colors = dataColors.split(",");
}
