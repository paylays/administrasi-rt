    ...
    <div class="sm:max-w-md sm:w-full m-3 sm:mx-auto flex flex-col bg-white shadow-sm rounded dark:bg-gray-800">
        <form id="delete-form" method="POST" action="">
            ...
            <div class="p-4 space-y-2 text-sm">
                <p>
                    <strong>NIK:</strong> <span id="delete-nik"></span>
                </p>
                <p>
                    <strong>Nama Lengkap:</strong> <span id="delete-nama_lengkap"></span>
                </p>
                <p>Apakah Anda yakin ingin menghapus akun warga tersebut?</p>
            </div>
