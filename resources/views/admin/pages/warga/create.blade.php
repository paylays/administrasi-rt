            ...
            @csrf
                ...
                <div class="grid md:grid-cols-3 grid-cols-1 gap-6 mb-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input class="form-input" type="text" id="nama_lengkap" name="nama_lengkap" placeholder="Masukkan nama lengkap">
                    </div>
                ...
                <div class="flex gap-2 justify-end items-center">
                    <a href="{{ route('admin.data-warga') }}" class="btn bg-light text-gray-800">Kembali</a>
